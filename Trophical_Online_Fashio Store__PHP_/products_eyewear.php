            ...
            $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");
                ...
                if (!in_array($_GET["id"], $item_array_id)) 
                {
                    ...
                    'item_quantity' => $_POST["quantity"]
                        ...
                        header("location: products_eyewear.php?#product_glasses-section-27 ");
                ...
                else
                {
                        ...
                        header("location: products_eyewear.php?#product_glasses-section-29 ");
...
<html>
    <head>
        ...
        <title>  Eye wears - Trophical</title>
    ...
    <!-- ///////////////////////////////////////////////////// -->
        ...
        <div class="container" style = "width:700px;">
                    ...
                    <br>
                    <h1 style="text-align: center;font-size: 40px; font-family: san serif; color: teal;"> Branded Eye wears</h1>
                    <br>
                            <?php
                        
                        $query = "select * from tbl_products where product_type = 'glasses' ";
                        ...
                        <div id = "product_glasses-section-<?php echo $row["pid"]; ?>">
                            <div class="col-md-8">
                             
                                <form method ="post" action="products_eyewear.php?action=add&id=<?php echo $row["pid"];?>">
        ...
        <nav aria-label="Page navigation example">
                        <ul class="pagination">
                                ...
                                <a class="page-link" href="products_watch.php" aria-label="Previous">
                                    <span aria-hidden="true">«</span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                </li>
                                <li class="page-item pagination-lg"><a class="page-link" href="products.php">1</a></li>
                                ...
                                <li class="page-item active pagination-lg"><a class="page-link" href="products_eyewear.php">5</a></li>
                                <!-- <li class="page-item">
                                <a class="page-link" href="products_eyewear.php" aria-label="Next">
                                    <span aria-hidden="true">»</span>
