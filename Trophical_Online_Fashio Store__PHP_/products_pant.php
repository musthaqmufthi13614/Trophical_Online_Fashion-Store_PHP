            ...
            $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");
                ...
                if (!in_array($_GET["id"], $item_array_id)) 
                {
                    ...
                    'item_quantity' => $_POST["quantity"]
                        ...
                        header("location: products_pant.php?#product_pants-section-15 ");
                ...
                else
                {
                        ...
                        header("location: products_pant.php?#product_pants-section-16 ");
...
<html>
    ...
    <!-- ///////////////////////////////////////////////////// -->
        ...
        <div class="container" style = "width:700px;">
                    ...
                    <br>
                    <h1 style="text-align: center;font-size: 40px; font-family: san serif; color: teal;"> Branded Pants</h1>
                    <br>
                            <?php
                        
                        $query = "select * from tbl_products where product_type = 'trousers' ";
                        ...
                        <div id = "product_pants-section-<?php echo $row["pid"]; ?>">
                            <div class="col-md-8">
                             
                                <form method ="post" action="products_pant.php?action=add&id=<?php echo $row["pid"];?>">
        ...
        <nav aria-label="Page navigation example">
                        <ul class="pagination">
                                ...
                                <li class="page-item active pagination-lg"><a class="page-link" href="products_pant.php">2</a></li>
                                ...
                                <li class="page-item pagination-lg">
                                <a class="page-link" href="products_shoe.php" aria-label="Next">
                                    <span aria-hidden="true">»</span>
