            ...
            $item_array_id = array_column($_SESSION["shopping_cart"], "item_id");
                ...
                if (!in_array($_GET["id"], $item_array_id)) 
                {
                    ...
                    'item_quantity' => $_POST["quantity"]
                        ...
                        header("location: products_watch.php?#product_watches-section-8 ");
                ...
                else
                {
                        ...
                        header("location: products_watch.php?#product_watches-section-11 ");
...
<html>
    ...
    <!-- ///////////////////////////////////////////////////// -->
        ...
        <div class="container" style = "width:700px;">
                    ...
                    <br>
                    <h1 style="text-align: center;font-size: 40px; font-family: san serif; color: teal;"> Branded Watches</h1>
                    <br>
                            <?php
                        
                        $query = "select * from tbl_products where product_type = 'watches' ";
                        ...
                        <div id = "product_watches-section-<?php echo $row["pid"]; ?>">
                            <div class="col-md-8">
                             
                                <form method ="post" action="products_watch.php?action=add&id=<?php echo $row["pid"];?>">
        ...
        <nav aria-label="Page navigation example">
                        <ul class="pagination">
                                ...
                                <a class="page-link" href="products_shoe.php" aria-label="Previous">
                                ...
                                <li class="page-item active pagination-lg"><a class="page-link" href="products_watch.php">4</a></li>
