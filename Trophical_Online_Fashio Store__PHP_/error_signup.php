...
<html>
    <head>
        ...
        <title> Error Signup - Trophical</title>
    ...
    <br> <br> <br> <br> <br>  <br> <br>  
            ...
            <h1 class = "er-snup"> Signup Failed.!<h1>

            <h3 class = "er-snup_msg"> provided Username was already in use, <h3>
            <h3 class = "er-snup_msg"> give a unique Username for your Signup Process.! <h3>
    ...
    <div >
        ...
        <button type = "button" id = "er-snup-btn" class="btn btn-primary" style = "text-transform:initial" >       
                    Try Again 
                    <i style = "margin-left:10px; font-size:20px;" class = "fa fa-rotate-right"></i>
        </button>
