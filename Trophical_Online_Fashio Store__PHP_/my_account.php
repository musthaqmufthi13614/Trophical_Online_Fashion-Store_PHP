...
<html>
    <head>
        ...
        <title> My Account - Trophical</title>
...
<h1>
    Welcome <b>
        ...
        ?> </b> ! We are here to Proudly introduce our Branded Products to You.
<!-- <br> -->
        <?php 
...
<!-- <br> -->
        ...
        ?>
<br>
        you're always being informed about our new upcoming branded releases via your email <b>
        <?php 
...
<div >
        ...
        <button type = "button" id = "er-snup-btn" class="btn btn-info" style = "text-transform:initial" >       
                          Back to Home
                    <i style = "margin-left:10px; font-size:30px;" class = "fa fa-home"></i>
        </button>
...
<!-- /////////VIEW SHOPPING CART /////////// -->
  <div >
        ...
        <button type = "button" id = "er-snup-btn" class="btn btn-info" style = "text-transform:initial" >       
                         View Shopping Cart
                    <i style = "margin-left:10px; font-size:30px;" class = "fa fa-shopping-cart"></i>
        </button>
