...
<html>
    <head>
        ...
        <title> Admin Login - Trophical</title>
...
<br> <br> <br> <br> <br> <br> <br> <br> <br> 
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 style = "color:#c4b8c4; font-size:30px;"> Admin Login</h1>

                            <form action="admin_validation.php" method="post" style = "color: grey">
                            ...
                            <br>
                            <a href= "account.php" style = "color:grey; font-size:13px;"> Are you a Customer? Login Here</a>
